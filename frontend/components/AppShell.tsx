...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // If in admin route, omit public blog header, footer, and floating settings
  if (isAdmin) {
    return <>{children}</>;
  }
  ...
  return (
    <>
      {/* Public Blog Header */}
      <header className="bg-white dark:bg-[#181818] border-b border-gray-200 dark:border-[#222] text-sm transition-colors duration-300 sticky top-0 z-40">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 md:space-x-4 text-gray-400">
            <div className="hidden md:flex items-center space-x-4">
              <a href="https://github.com/chabuuuu" target="_blank" rel="noreferrer" className="hover:text-white transition">
                <Github size={18} />
              </a>
              <a href="https://www.facebook.com/thinhha123" target="_blank" rel="noreferrer" className="hover:text-blue-500 transition">
                <Facebook size={18} />
              </a>
              <a href="https://www.youtube.com/@chabu4877" target="_blank" rel="noreferrer" className="hover:text-red-500 transition">
                <Youtube size={18} />
              </a>
            </div>
            <Suspense>
